...
| Arithmetic    | `+ - * / **`, unary minus, `@` matrix-vector product; elementwise array ops; scalar↔array broadcasting |
...
$ cargo run -p scirust-transpiler --example oracle
  ...
  ✓ solve/det/eigvalsh/inv/A@b   200/200 trials match   (routed to scirust-solvers)
