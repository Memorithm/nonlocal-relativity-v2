...
- `scirust quantum [--seed N] [--qubits Q] [--chi C]` — simulador de circuitos cuánticos MPS / Tensor-Train (SVD truncada propia, sin FFI); muestra un estado GHZ exacto e informa la dimensión de enlace y la huella de memoria del MPS frente a un vector de estado denso 2ⁿ.
