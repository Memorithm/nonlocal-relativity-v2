...
- **Inférence** : décodage spéculatif exact (préservant la sortie), une
  FlashAttention à softmax en ligne par tuiles, une couche DeltaNet d'attention linéaire à règle delta, une couche Mamba à état-espace sélectif et une couche de rétention RetNet.
