...
//! - a left-sided Caputo derivative using the L1 uniform-grid scheme.
//!
//! The first release deliberately supports only `0 < alpha < 1`. Higher
//! orders, non-uniform grids, fast history compression and multidimensional
//! Riesz operators require distinct numerical contracts and will be added
//! separately.
//!
//! ## Example
//!
