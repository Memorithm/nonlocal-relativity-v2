...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (96 tests) |
...
**Résultat de l'oracle (reproductible).** 139 cas au total : 43 Python prouvés
contre **NumPy réel**, 96 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
