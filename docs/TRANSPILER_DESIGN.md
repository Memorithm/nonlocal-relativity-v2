...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (76 tests) |
...
**Résultat de l'oracle (reproductible).** 87 cas au total : 43 Python prouvés
contre **NumPy réel**, 44 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
