...
| Tests unitaires (gate CI, sans Python/Octave) | ✅ livré | `scirust-transpiler/src/lib.rs` (86 tests) |
...
**Résultat de l'oracle (reproductible).** 107 cas au total : 43 Python prouvés
contre **NumPy réel**, 64 MATLAB prouvés contre **Octave réel** (chacun 200 essais).
