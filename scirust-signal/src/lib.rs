...
//!   peak-to-sidelobe ratio) and CFAR detection (cell-averaging and
...
pub use radar::{
    barker_code, ca_cfar, ca_cfar_alpha, cross_correlate, lfm_chirp, os_cfar, os_cfar_alpha,
    peak_lag, peak_to_sidelobe,
};
